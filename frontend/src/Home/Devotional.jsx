...
function Tranding() {
  ...
  return (
    <div>
      <h1 className="ml-20 font-bold text-3xl mb-8 mt-6">Sport</h1>
         <p className="text-center mb-8">
Sports encompass a wide range of physical activities governed by rules, often involving competition and skill, whether played individually or in teams        </p>
